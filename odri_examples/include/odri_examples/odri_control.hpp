...
#include "odri_ros2_msgs/srv/direct_command.hpp"
#include "odri_ros2_msgs/srv/position_command.hpp"
...
private:
  ...
  void callbackDirectCommand(const std::shared_ptr<odri_ros2_msgs::srv::DirectCommand::Request> request,
  ...
  void callbackPositionCommand(const std::shared_ptr<odri_ros2_msgs::srv::PositionCommand::Request> request,
...
private:
  ...
  rclcpp::Service<odri_ros2_msgs::srv::DirectCommand>::SharedPtr direct_command_srv_;
  rclcpp::Service<odri_ros2_msgs::srv::PositionCommand>::SharedPtr position_command_srv_;
