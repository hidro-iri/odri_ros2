...
OdriControl::OdriControl(const std::string &node_name) : Node(node_name)
{
  ...
  pub_robot_command_ = create_publisher<odri_ros2_interfaces::msg::RobotCommand>("odri/robot_command", 1);
  ...
  direct_command_srv_ = create_service<odri_ros2_interfaces::srv::DirectCommand>(
      "direct_command", std::bind(&OdriControl::callbackDirectCommand, this, std::placeholders::_1, std::placeholders::_2));

  position_command_srv_ = create_service<odri_ros2_interfaces::srv::PositionCommand>(
  ...
  // Initialize message
  msg_robot_command_ = odri_ros2_interfaces::msg::RobotCommand();
}
...
void OdriControl::callbackRobotState(const odri_ros2_interfaces::msg::RobotState::SharedPtr msg)
{
  for (std::size_t i = 0; i < 2; ++i)
  {
...
void OdriControl::callbackDirectCommand(const std::shared_ptr<odri_ros2_interfaces::srv::DirectCommand::Request> request,
...
void OdriControl::callbackPositionCommand(const std::shared_ptr<odri_ros2_interfaces::srv::PositionCommand::Request> request,
